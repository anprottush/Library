...
@Component({
  ...
  templateUrl: './storebook-create.component.html',
  styleUrls: ['./storebook.component.css']
})
export class StoreBookCreateComponent  implements OnInit {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      storebookcategory: ['', Validators.required],
  ...
  get storebookcategory() {
    return this.form.get('storebookcategory');
  }
  ...
  ngOnInit(): void {
    this.route.params.subscribe((params: any) => {
      ...
      if (params['id'] != null) {
        ...
        this.memberDataSubscription = this.storeBookService.storeBookData.subscribe(data => {
          ...
          if (data) {
            this.form.setValue({
              ...
              codeno: data.code_no,
              photo: data.photo,
              storebookcategory: data.category,
              isbnno: data.isbn_no,
  ...
  onSubmit(): void {
    ...
    formData.append('category', this.form.value.storebookcategory);
    ...
    var data = {
      ...
      category: this.form.value.storebookcategory,
